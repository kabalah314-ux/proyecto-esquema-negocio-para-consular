...
const categories = [
  {
    ...
    services: [
      { name: "Maderoterapia", problem: "Celulitis, grasa localizada, piel de naranja, modelado corporal", duration: "45–60 min", price: "50–60 €", demand: 98, star: true },
      { name: "Masaje Reductor", problem: "Reducción de medidas, moldear silueta (abdomen, piernas, glúteos)", duration: "50–60 min", price: "50–60 €", demand: 85 },
      { name: "Drenaje Linfático", problem: "Retención de líquidos, hinchazón, postoperatorios, piernas pesadas", duration: "60–75 min", price: "55–60 €", demand: 90 },
      { name: "Masaje Anticelulítico", problem: "Celulitis, mala circulación, firmeza de piel", duration: "45–60 min", price: "45–60 €", demand: 82 },
      { name: "Masaje con Ventosas", problem: "Descontracturar, mejorar circulación, celulitis superficial", duration: "45 min", price: "45–60 €", demand: 75 },
    ],
  },
  {
    id: "terapeuticos",
    ...
    services: [
      { name: "Masaje Descontracturante", problem: "Contracturas, tensión muscular, dolor de espalda/cuello", duration: "50–60 min", price: "50–60 €", demand: 88 },
      { name: "Masaje Relajante / Sueco", problem: "Estrés, ansiedad, tensión general", duration: "60 min", price: "45–60 €", demand: 80 },
      { name: "Masaje Prenatal", problem: "Dolores lumbar, piernas, hinchazón en embarazo", duration: "45–60 min", price: "50–60 €", demand: 72 },
      { name: "Reflexología Podal", problem: "Cansancio, estrés, dolores en pies", duration: "45 min", price: "40–55 €", demand: 65 },
      { name: "Masaje Postparto", problem: "Recuperación física, drenaje, relajación", duration: "60 min", price: "55–60 €", demand: 78 },
    ],
  },
];
